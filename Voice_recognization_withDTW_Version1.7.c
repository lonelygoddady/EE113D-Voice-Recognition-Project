...
#define THRESHOLD 2000000 //Sensitivity of the microphone
#define data_base_size 11 //size of the library (60) - five ppl: George, Ben, Lyn, Briggs, Yuyu
#define free_mode_size 11 //free-mode library
...

{
  ...
  while (1)
  {
	if (signal == 0)
	{
		if (inst != 6)
		{
		  printf("*********VOICE RECOGNITION MACHINE CEREAL VERSION 1.7**************\n");
		...
		for (j = 0; j<data_base_size; j++)
			{
				...
				strcpy(file_name[j], "C:\\Users\\EE113D\\MyProjects\\voice_recongization_project\\free_mode_memory\\memory_");
